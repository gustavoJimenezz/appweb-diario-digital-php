                ...
                <div class="col-lg-7">
                    <div class="p-5">
                        ...
                        <form class="user" id="registroForm" action="<?php echo RUTA_URL; ?>/AuthController/registrarLector/"
                            ...
                            <div class="form-group">
                                <input name="celular" type="celular" class="form-control form-control-user"
                        ...
                        <hr>
                        <div class="text-center">
                            <a class="small" href="<?php echo RUTA_URL;?>/AuthController/resetPassword">Olvidé mi contraseña</a>
                        </div>
                        <div class="text-center">
